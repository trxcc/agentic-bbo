...
If you want to override the bundled files with another uploaded dataset bundle, set `BBO_BO_TUTORIAL_SOURCE_ROOT=/path/to/source_root`; paths such as `examples/BH/BH_dataset.csv` are interpreted relative to that root.
